//
//  MenuTabCollectionViewModel.swift
//  GithubUser
//
...
class MenuTabCollectionViewModel {
    ...
    private func handleUserChanges(_ user: [MappableObject]) {
        ...
        let questionSection = GithubUserSectionModel(objects: user, sectionName: SectionName.user.rawValue, cellUIProvider: MenuTabCellUIProvider())
